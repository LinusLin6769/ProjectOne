# ProjectOne — Tasks
Claim a task by setting Owner + Status = `doing` before working.
Statuses: `todo` / `doing` / `blocked`. Finished tasks are removed — `git log` is the record.
## Open
- T-002 — Run intake interview (define profile + purpose) — Owner: purpose-track — doing
...
- T-011 — Research open-source/cost-effective alternatives to paid-per-token AI tooling (coding-agent CLIs, local models) — see context/ai-cost-alternatives.md — Owner: ai-cost-research — doing
